...
QT_MOC_LITERAL(1, 10, 12), // "mousePressed"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 13), // "mouseReleased"
QT_MOC_LITERAL(4, 38, 9) // "mouseMove"

    },
    "ImageArea\0mousePressed\0\0mouseReleased\0"
    "mouseMove"
};
...
void ImageArea::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->mouseMove((*reinterpret_cast< const QPoint(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ImageArea::mousePressed)) {
                *result = 0;
            }
        }
        {
            typedef void (ImageArea::*_t)(const QPoint & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ImageArea::mouseReleased)) {
                *result = 1;
            }
        }
        {
            typedef void (ImageArea::*_t)(const QPoint & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ImageArea::mouseMove)) {
                *result = 2;
            }
        }
    }
...
const QMetaObject ImageArea::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ImageArea.data,
      qt_meta_data_ImageArea,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void ImageArea::mousePressed(const QPoint & _t1)
{
...
// SIGNAL 1
void ImageArea::mouseReleased(const QPoint & _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void ImageArea::mouseMove(const QPoint & _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
